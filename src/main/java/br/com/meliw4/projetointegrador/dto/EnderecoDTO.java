...
public class EnderecoDTO {
	...
	@Size(max = 60, message = "Logradouro não pode exceder 60 caracteres")
	private String logradouro;

	private Integer numero;
	@NotEmpty(message = "Bairro não pode estar em branco")
	@Size(max = 60, message = "Bairro não pode exceder 60 caracteres")
	private String bairro;
	@NotEmpty(message = "Cidade não pode estar em branco")
	@Size(max = 60, message = "Cidade não pode exceder 60 caracteres")
	private String cidade;
	@NotEmpty(message = "Estado não pode estar em branco")
	@Size(max = 30, message = "Estado não pode exceder 30 caracteres")
