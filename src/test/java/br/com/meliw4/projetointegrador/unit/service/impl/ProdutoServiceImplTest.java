...
public class ProdutoServiceImplTest {
	...
	private static List<ProdutoVendedor> makeProdutoVendedores() {
		...
		lote1.setSetor(Setor.builder().id(1L).armazem(Armazem.builder().id(1L).nome("Armazem 1").volume(111d).build())
				.build());
		...
		lote2.setSetor(Setor.builder().id(2L).armazem(Armazem.builder().id(2L).nome("Armazem 1").volume(111d).build())
				.build());
